...
local function m_AlignText(text, font, x, y, xalign, yalign)
	...
	if yalign == TEXT_ALIGN_BOTTOM then y = y - texth end
	return x, y
end
...
function DrawElecticText(intensity, text, font, x, y, color, xalign, yalign)
	...
	draw.SimpleText(text, font, x, y, color, xalign, yalign)
	if electric_effect_a > 0 then electric_effect_a = electric_effect_a - (1000 * FrameTime()) end
...
function DrawFireText(intensity, text, font, x, y, color, xalign, yalign, glow, shadow)
	...
	if shadow then draw.SimpleText(text, font, x + 1, y + 1, Color(0, 0, 0), xalign, yalign) end
	draw.SimpleText(text, font, x, y, color, xalign, yalign)
end
